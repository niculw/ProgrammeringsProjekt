...
void initMenu(){
	color(5,0);
	gotoxy(XPOS - 18, 1);
	printf("         .8.          8 888888888o.   8 8888     ,88'          .8.          b.             8     ,o888888o.      8 8888 8 888888888o.      ");gotoxy(XPOS - 18, 1);
	printf("        .888.         8 8888    `88.  8 8888    ,88'          .888.         888o.          8  . 8888     `88.    8 8888 8 8888    `^888.   ");gotoxy(XPOS - 18, 2);
	printf("       :88888.        8 8888     `88  8 8888   ,88'          :88888.        Y88888o.       8 ,8 8888       `8b   8 8888 8 8888        `88. ");gotoxy(XPOS - 18, 3);
	printf("      . `88888.       8 8888     ,88  8 8888  ,88'          . `88888.       .`Y888888o.    8 88 8888        `8b  8 8888 8 8888         `88 ");gotoxy(XPOS - 18, 4);
	printf("     .8. `88888.      8 8888.   ,88'  8 8888 ,88'          .8. `88888.      8o. `Y888888o. 8 88 8888         88  8 8888 8 8888          88 ");gotoxy(XPOS - 18, 5);
	printf("    .8`8. `88888.     8 888888888P'   8 8888 88'          .8`8. `88888.     8`Y8o. `Y88888o8 88 8888         88  8 8888 8 8888          88 ");gotoxy(XPOS - 18, 6);
	printf("   .8' `8. `88888.    8 8888`8b       8 888888<          .8' `8. `88888.    8   `Y8o. `Y8888 88 8888        ,8P  8 8888 8 8888         ,88 ");gotoxy(XPOS - 18, 7);
	printf("  .8'   `8. `88888.   8 8888 `8b.     8 8888 `Y8.       .8'   `8. `88888.   8      `Y8o. `Y8 `8 8888       ,8P   8 8888 8 8888        ,88' ");gotoxy(XPOS - 18, 8);
	printf(" .888888888. `88888.  8 8888   `8b.   8 8888   `Y8.    .888888888. `88888.  8         `Y8o.`  ` 8888     ,88'    8 8888 8 8888    ,o88P'   ");gotoxy(XPOS - 18, 9);
	printf(".8'       `8. `88888. 8 8888     `88. 8 8888     `Y8. .8'       `8. `88888. 8            `Yo     `8888888P'      8 8888 8 888888888P'      ");gotoxy(XPOS +35, 11);
